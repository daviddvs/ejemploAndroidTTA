...
public class RestClient {
    ...
    public void setHttpBsicAuth(String user, String passwd){
    ...
    public int postFile(String path, InputStream is, String fileName) throws IOException {
        String boundary = Long.toString(System.currentTimeMillis()); // Esta es la separacion que se usa para identificar contenido nuevo
        String newLine = "\r\n";
        String prefix = "--";
        HttpURLConnection conn = null;
        try{
